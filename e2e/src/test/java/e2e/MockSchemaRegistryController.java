...
class MockSchemaRegistryController {
	...
	@PostMapping(path = "/subjects/{subject}/versions", consumes = "application/vnd.schemaregistry.v1+json")
	public Map<String, Integer> register(@PathVariable("subject") String subject, @RequestBody RegisterRequest req,
	...
	public Map<String, String> schemaById(@PathVariable("id") int id) throws IOException, RestClientException {
	...
	public Map<String, Object> latest(@PathVariable("subject") String subject) throws IOException, RestClientException {

		var meta = client.getLatestSchemaMetadata(subject);
		return Map.of("subject", subject, "version", meta.getVersion(), "id", meta.getId(), "schema", meta.getSchema());
	}
